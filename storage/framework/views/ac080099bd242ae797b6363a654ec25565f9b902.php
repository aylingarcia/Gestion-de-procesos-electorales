...
<body onload="startTime()">
 ...
 <nav>
    <div class="navbar">
      ...
      <div class="logo"><a href="#"><img src="assets/images/logo.png" alt="DPG" style="width: 250px;"></a></div>
      <div class="nav-links">
        <div class="sidebar-logo">
          <span class="logo-name">Posgrado FCyT</span>
          <i class='bx bx-x' ></i>
        </div>
        <ul class="links">
          <li><a class=" <?php echo e(request()-> is('/') ? 'active' : ''); ?>" href="/">Inicio</a></li>
          <li>
            <a href="#">Programas de Posgrado</a>
            <i class='bx bxs-chevron-down htmlcss-arrow arrow  '></i>
            <ul class="htmlCss-sub-menu sub-menu">
              <li><a href="diplomados">Diplomados</a></li>
              <li><a href="maestrias">Maestrias</a></li>
              ...
              <li class="more">
                ...
                <ul class="more-sub-menu sub-menu">
                  <li><a href="cursos">Cursos Cortos</a></li>
                </ul>
              </li>
            </ul>
          </li>
          <li><a class=" <?php echo e(request()-> is('documentacion') ? 'active' : ''); ?>" href="documentacion">Documentación</a></li>
          <li><a class=" <?php echo e(request()-> is('ddigital') ? 'active' : ''); ?>" href="ddigital">DDigital</a></li>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li><a class=" <?php echo e(request()-> is('maestrias') ? 'active' : ''); ?>" href="maestrias">Maestrías</a></li>
                      <li><a class=" <?php echo e(request()-> is('doctorados') ? 'active' : ''); ?>" href="doctorados">Doctorados</a></li>
                      <li><a class=" <?php echo e(request()-> is('documentacion') ? 'active' : ''); ?>" href="documentacion">Documentación</a></li>
                      <li><a class=" <?php echo e(request()-> is('contactos') ? 'active' : ''); ?>" href="contactos">Contactos</a></li>
...
</html><?php /**PATH D:\Harold\Página Web\Oficial 2023\PaginaV construccion\resources\views/base.blade.php ENDPATH**/ ?>