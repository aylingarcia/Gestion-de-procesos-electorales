    ...
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <ul class="links">
          ...
          <li><a class=" {{ request()-> is('documentacion') ? 'active' : ''}}" href="documentacion">Documentación</a></li>
          
          <li><a class=" {{ request()-> is('acercade') ? 'active' : ''}}" href="acercade">Acerca de</a></li>
          <li><a class=" {{ request()-> is('contactos') ? 'active' : ''}}" href="contactos">Contactos</a></li>
          <li style="background-color:red;"><a class=" {{ request()-> is('login') ? 'active' : ''}}" href="login">Ingreso</a></li>
        </ul>
      </div>
