...
@enderror<br><br>
                ...
                <label for="cantCandidatos">Cantidad de Candidatos:</label>
                <select name="cantCandidatos" id="cantCandidatos" required>
                ...
                <input type="text" placeholder="Escribe el Cnombre aquí..." maxlength="30"
                oninput="this.value = this.value.replace(/[^A-Za-z,. ]+/g, '')"
                name="nombrecandidato2" value="{{ isset($frente) ? $frente->nombrecandidato1 : old('nombrecandidato2') }}" id="codSis" required>
                </div>
                <div class="campo-adicional" id="candidato3">
                <label for="profesion">Nombre Candidato de Frente 3:</label>
                <input type="text" placeholder="Escribe el Cnombre aquí..." maxlength="30"
                oninput="this.value = this.value.replace(/[^A-Za-z,. ]+/g, '')"
                name="nombrecandidato3" value="{{ isset($frente) ? $frente->nombrecandidato3 : old('nombrecandidato1') }}" id="codSis" required>
                </div>
                <div class="campo-adicional" id="candidato4">
                <label for="profesion">Nombre Candidato de Frente 4:</label>
                <input type="text" placeholder="Escribe el Cnombre aquí..." maxlength="30"
                oninput="this.value = this.value.replace(/[^A-Za-z,. ]+/g, '')"
                name="nombrecandidato4" value="{{ isset($frente) ? $frente->nombrecandidato4 : old('nombrecandidato1') }}" id="codSis" required>
                </div>
